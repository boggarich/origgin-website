...
export default class BoardOfDirectors extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            modalCeoShow: false,
            modalLawyerShow: false,
            modalWorlanyoShow: false,
            modalCtoShow: false,
            modalCboShow: false,
        }
    }
    ...
    handleCboModalClose = () => {
        ...
        this.setState({ modalCboShow: false });

    }

    handleCtoModalClose = () => {

        this.setState({ modalCtoShow: false });

    }

    handleWorlanyoModalClose = () => {

        this.setState({ modalWorlanyoShow: false });

    }

    handleLawyerModalClose = () => {

        this.setState({ modalLawyerShow: false });

    }

    handleCeoModalClose = () => {

        this.setState({ modalCeoShow: false });
    ...
    componentDidMount() {
        ...
        $('.profile-link').on('click', (e) => {
            ...
            if(data === 'ceo') {
                ...
                this.setState({ modalCeoShow: true });

            }

            if(data === 'lawyer') {

                this.setState({ modalLawyerShow: true });

            }

            if(data === 'worlanyo') {

                this.setState({ modalWorlanyoShow: true });

            }

            if(data === 'cto') {

                this.setState({ modalCtoShow: true });

            }

            if(data === 'cbo') {

                this.setState({ modalCboShow: true });
    ...
    render() {
        ...
        return (
            ...
            <>
                    ...
                    <div className="page-container team">
                        ...
                        <div className="page-hero" data-aos="fade-up">
                            ...
                            <div className="layout-width">
                                <div>
                                    <h1 className="page-hero-header">Board of Directors</h1>
                        ...
                        <section className="section-1" data-aos="fade-up">
                            <div className="layout-width">
                                ...
                                <div className="grid-3 mb-lg-5 pb-5">

                                    <Link className="profile-link" data-profile="ceo" to="/">
                                        <div className="profile-container">

                                            <div className="profile-img-container board-chair"></div>
                                            <h3 className="header-lg">Kane Mani</h3>
                                            <h6 className="sub-header">Co-founder, Chairman and<br/> CEO, Origgin Ltd</h6>
                                        </div>
                                    </Link>

                                    <Link className="profile-link" data-profile="lawyer" to="/">
                                        <div className="profile-container">

                                            <div className="profile-img-container paul-mayer-aboagye"></div>
                                            <h3 className="header-lg">Paul Mayer Aboagye</h3>
                                            <h6 className="sub-header">Lawyer and Chief of Staff,<br/> Palmers Green International Ltd</h6>

                                        </div>
                                    </Link>

                                    <Link className="profile-link" data-profile="worlanyo" to="/">
                                        <div className="profile-container">

                                            <div className="profile-img-container worlanyo-forster"></div>
                                            <h3 className="header-lg">Worlanyo Forster</h3>
                                ...
                                <div className="d-flex align-center justify-content-center w-65 mx-auto pb-5 mb-5">
                                    <div className="grid-2">
                                        ...
                                        <Link className="profile-link d-flex justify-content-center pt-5 pt-lg-0" data-profile="cbo" to="/">
                                            <div className="profile-container">
                            ...
                            <div className="modal-content-container">
                                    ...
                                    <div className="profile-img-container">
                                        ...
                                        <div>
                                            ...
                                            <h3 className="header-lg">Kane Mani</h3>
                                            <h6 className="sub-header text-nowrap">Co-founder, Chairman and<br/> CEO, Origgin Ltd</h6>
                                        </div>
                ...
                <Modal
                    show={this.state.modalLawyerShow}
                    onHide={this.handleLawyerModalClose}
                    size="lg"
                    aria-labelledby="contained-modal-title-vcenter"
                    centered
                    className="team-modal"
                        ...
                        <Modal.Body>
                            <div className="modal-content-container">
                                    ...
                                    <div className="profile-img-container">
                                        ...
                                        <div>
                                            <div className="profile-img lawyer"></div>
                                            <h3 className="header-lg">Paul Mayer Aboagye</h3>
                                            <h6 className="sub-header text-nowrap">Lawyer and Chief of Staff,<br/> Palmers Green International Ltd</h6>
                                        </div>
                ...
                <Modal
                    show={this.state.modalWorlanyoShow}
                    onHide={this.handleWorlanyoModalClose}
                    size="lg"
                    aria-labelledby="contained-modal-title-vcenter"
                    centered
                    className="team-modal"
                            ...
                            <div className="modal-content-container">
                                    ...
                                    <div className="profile-img-container">
                                        ...
                                        <div>
                                            <img src={ process.env.PUBLIC_URL + "/img/WhatsApp Image 2022-08-05 at 11.18.20 AM.jpeg" } alt="human"/>
                                            <h3 className="header-lg">Kane Mani</h3>
                                            <h6 className="sub-header">Chief Executive Officer</h6>
                                        </div>
                ...
                <Modal
                    show={this.state.modalCboShow}
                    onHide={this.handleCboModalClose}
                    size="lg"
                    aria-labelledby="contained-modal-title-vcenter"
                    centered
                    className="team-modal"
