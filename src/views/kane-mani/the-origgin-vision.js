...
export default class TheOriginVision extends React.Component {
            ...
            <>
                ...
                <div className="main-content header-white-bg"> 
                    <div className="page-container the-origgin-vision">
                        ...
                        <section className="page-hero d-flex align-items-center" data-aos="fade-up">
                            <div className="layout-width">
                                <h3 className="sub-header fw-600">
